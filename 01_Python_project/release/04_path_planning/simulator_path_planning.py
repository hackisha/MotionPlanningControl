...
Usage (git root cwd 기준):
    ...
    uv run python 01_Python_project_refactored/solutions/04_path_planning/simulator_path_planning.py

    # 2) 파일 또는 디렉토리 지정
    uv run python 01_Python_project_refactored/solutions/04_path_planning/simulator_path_planning.py \\
        01_Python_project_refactored/solutions/04_path_planning/01_both_lane/
